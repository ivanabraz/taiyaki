            ...
            <Transition.Root show={open} as={Fragment}>
                <Dialog as="div" className="fixed inset-0 flex z-40 lg:hidden" onClose={setOpen}>
                    ...
                    <div className="border-t border-gray-200 py-6 px-4 items-center">
                        <img src="https://tailwindui.com/img/flags/flag-united-kingdom.svg" alt="Country flag" className="w-5 h-auto inline flex-shrink-0" />
                        <span className="ml-3 inline text-base font-medium text-gray-900">UK</span>
                    </div>
                </div>
            </Transition.Child>
            </Dialog>
                                ...
                                <div className="h-full flex space-x-8">
                                    <Popover className="flex">
                                        {({ openCart }) => (
                                            <>
                                                <div className="relative flex">
                                                    <Popover.Button onClick={() => setOpenCart(true)}>
                                                        <CartWidget/>
                                                    </Popover.Button>
                                                </div>
                                                <Transition enter="transition ease-out duration-200" enterFrom="opacity-0" enterTo="opacity-100" leave="transition ease-in duration-150" leaveFrom="opacity-100" leaveTo="opacity-0">
                                                    <Popover.Panel className="absolute top-full inset-x-0 text-sm text-gray-500">
                                                        <ShoppingCart/>
                                                    </Popover.Panel>
                                                </Transition>
